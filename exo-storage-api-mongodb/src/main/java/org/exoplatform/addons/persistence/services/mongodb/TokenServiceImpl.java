...
import org.exoplatform.addons.persistence.utils.MessageDigester;
...
@Named("tokenService")
@ApplicationScoped
public class TokenServiceImpl implements org.exoplatform.addons.persistence.services.TokenService
{
